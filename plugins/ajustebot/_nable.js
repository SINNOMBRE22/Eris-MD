...
const handler = async (m, { conn, usedPrefix, command, args, isOwner, isAdmin, isROwner }) => {
  ...
  // --- SWITCH DE COMANDOS ACTUALIZADO ---
  switch (type) {
    case 'welcome':
    case 'bv':
    case 'bienvenida':
  ...
  // --- RESPUESTA FINAL CAPITALIZADA ---
  const mensajeFinal = `《✦》La Función *${type.toUpperCase()}* Se *${isEnable ? 'Activó' : 'Desactivó'}* ${isAll ? 'Para Este Bot' : isUser ? '' : 'Para Este Chat'}`;
